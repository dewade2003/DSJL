...
namespace DSJL.DBUtility
{
    ...
    public class DbHelperOleDb
    {
        ...
        static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + GetAppPath() + "\\AppData\\DSJLDB.mdb" + ";Jet OLEDB:Database Password=" + conPwd;
        //public static string connectionString = ConfigurationManager.ConnectionStrings["SportTestCon"].ConnectionString + conPwd; 		
        ...
        /// 设置外部数据库路径
        /// </summary>
        /// <param name="path">数据库完整路径</param>
        public static void SetDBPath(string path) {
            connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + path + ";Jet OLEDB:Database Password=" + conPwd;
        }

        /// <summary>
        /// 设置为默认的数据库路径
        /// </summary>
        public static void SetDefaultDBPath() {
            connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + GetAppPath() + "\\AppData\\DSJLDB.mdb" + ";Jet OLEDB:Database Password=" + conPwd;
        }
