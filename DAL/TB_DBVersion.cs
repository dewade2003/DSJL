...
namespace DSJL.DAL
{
	...
	public partial class TB_DBVersion
	{
		...
		public int GetMaxId()
		{
		return DbHelperOleDb.GetMaxID("ID", "TB_DBVersion"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from TB_DBVersion");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TB_DBVersion ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DSJL.Model.TB_DBVersion GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,versioncode from TB_DBVersion ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
			...
			DSJL.Model.TB_DBVersion model=new DSJL.Model.TB_DBVersion();
		...
		/// 得到一个对象实体
		/// </summary>
		public DSJL.Model.TB_DBVersion DataRowToModel(DataRow row)
		{
			DSJL.Model.TB_DBVersion model=new DSJL.Model.TB_DBVersion();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,versioncode ");
			strSql.Append(" FROM TB_DBVersion ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TB_DBVersion T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TB_DBVersion";
